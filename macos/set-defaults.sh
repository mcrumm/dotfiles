...
#
# Run ./set-defaults.sh and you'll be good to go.s
...
defaults write NSGlobalDomain AppleFontSmoothing -int 1s
...
# Safari preferences live in a sandboxed container on modern macOS.
# Writing to them requires Full Disk Access for the terminal app.
# (System Settings > Privacy & Security > Full Disk Access)
if defaults write com.apple.Safari __test_write -bool true 2>/dev/null; then
	defaults delete com.apple.Safari __test_write 2>/dev/null
	...
	defaults write com.apple.Safari ProxiesInBookmarksBar -array
	...
	echo “Skipping Safari defaults — grant Full Disk Access to your terminal app to enable these.”
fi
